...
def cleanup_directory(base_dir, confirm_all):
    ...
    for root, dirs, files in os.walk(base_dir, topdown=False):
        ...
        # Move .pyc files from __pycache__
        for dir in dirs:
            if dir == '__pycache__':
                ...
                # Delete the empty __pycache__ directory
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        base_directory = os.getcwd()  # Default to current working directory

    # Confirm the operation once
    confirm = input(
    ...
    cleanup_directory(base_directory, confirm == 'y')
